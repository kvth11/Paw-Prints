...
class ScheduleUI:
    ...
    def load_schedule(self):
        ...
        for line in load_file_lines(APPROVED_APPOINTMENTS_FILE):
            try:
    ...
    def reformat_datetime(self, date_time_str):
        try:
            datetime_obj = datetime.strptime(date_time_str, "%m/%d/%y at %I:%M %p")
            return datetime_obj.strftime("%m/%d/%y at %I:%M %p")
        except ValueError:
